...
**Last updated:** 2026-07-16 — multiplicative resonance background
...
Resonance circle fitting 支援非等距 frequency grid：electrical-delay 初值由各相鄰
點的 phase/frequency slope 做 robust aggregation，resonance 初值由 frequency-aware
circle-phase slope 決定；generalized eigenproblem 以最接近零的 eigenpair 表示圓，
不因浮點誤差把 exact-circle eigenvalue 推到微小負值就選錯解。
