...
def add_fixed_params_back(
    pOpt: List[float], pCov: NDArray, fixedparams: Sequence[Optional[float]]
...
def fit_line(xdata: NDArray, ydata: NDArray) -> Tuple[float, float]:
    """params: [a, b] -> y = a * x + b"""
