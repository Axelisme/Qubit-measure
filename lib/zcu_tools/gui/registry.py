...
class Registry:
    ...
    def __init__(self) -> None:
        self._mapping: dict[str, type[AbsExpAdapter[Any, Any, Any]]] = {}

    def register(
        self, name: str, adapter_cls: type[AbsExpAdapter[Any, Any, Any]]
    ) -> None:
    ...
    def create(self, name: str) -> AbsExpAdapter[Any, Any, Any]:
