**Last updated:** 2026-06-17 (SoC connect is now a SYNCHRONOUS wire RPC `soc.connect` — the async `connect.start` + soc operation-handle is removed; make_soc_proxy fail-fast 1s COMMTIMEOUT; GUI async connect button untouched; WIRE 33, GUI 40, MCP 41)
