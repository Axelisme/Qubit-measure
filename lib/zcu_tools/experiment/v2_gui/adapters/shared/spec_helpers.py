...
from zcu_tools.gui.specs.readout import make_direct_readout_spec, make_pulse_readout_spec
...
def make_readout_ref_spec(label: str = "Readout", optional: bool = False) -> ModuleRefSpec:
...
def make_pulse_ref_spec(label: str = "Init Pulse", optional: bool = False) -> ModuleRefSpec:
    return ModuleRefSpec(
