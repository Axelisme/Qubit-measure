...
The blank is an inline pulse-readout (pulse + ro_cfg); if the library holds a
``ro_waveform`` it is referenced for the pulse waveform. The ref prefers the
calibrated library readouts (readout_dpm / readout_rf).
"""
