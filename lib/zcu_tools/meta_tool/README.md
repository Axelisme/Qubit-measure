...
**Last updated:** 2026-09-26 — SampleTable v2 pure migration API
...
## SampleTable v2 協定（`sample_schema.py`）
...
SampleTable          (獨立，供 notebook 記錄量測結果用；v2 協定由 sample_schema 提供，不改變 SampleTable 本身)
```
