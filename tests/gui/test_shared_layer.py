...
_SHARED_MODULES = [
    ...
    # ContextControlPort is the shared context/md/ml/value-source facet:
    # service types are type-only, runtime imports stay Qt/app clean.
    "zcu_tools.gui.session.context_control",
