"""Tests for FloatingFeedbackWidget (Stage 4a, ADR-0025 §Stop-gating).
...
from zcu_tools.gui.app.main.ui.feedback_widget import FloatingFeedbackWidget
...
def _make_ctrl(*, can_cancel: bool = True) -> MagicMock:
    """Build a mock Controller with the minimal surface FloatingFeedbackWidget uses."""
    ctrl = MagicMock()
...
def _find_btn(widget: FloatingFeedbackWidget, text: str) -> QPushButton:
...
def _get_input(widget: FloatingFeedbackWidget) -> QLineEdit:
