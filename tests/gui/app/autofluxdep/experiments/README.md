...
跨 experiment 的 orchestrator、persistence、cfg schema 與 artifact tests 留在上一層；共用 fixture 從 `tests.gui.app.autofluxdep._helpers` 引用，不在這裡建立第二份 production Builder registry。
