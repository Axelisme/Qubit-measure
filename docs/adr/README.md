...
- [0060 — Agent interface as second view](0060-measure-agent-interface-shared-gui-view.md)：量測 agent 經 40 個特化 tool 操作與 GUI 共用的狀態；一個判斷點一個 tool，寫入操作使 GUI 跟隨到對應子 tab。
