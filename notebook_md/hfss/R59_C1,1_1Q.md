...
C_matrix = np.linalg.inv(M) @ C_matrix @ np.linalg.inv(M)
...
result_path = r"C:\Users\SQC\Desktop\Axel\HFSS\Fluxonium2D_R59_1Q\Project3_LjSweep.csv"
...
dm.renderer.modeler.mesh_length(
    'port', ["Port_port_L_in", "Port_port_R_in", "launch_pad_port_L", "launch_pad_port_R"], 
    MaxLength='0.1mm'
)
