...
design.variables.cpw_width = 0.015  # type: ignore
design.variables.cpw_gap = 0.009  # type: ignore
var = design.variables
cpw_width, cpw_gap = var.cpw_width, var.cpw_gap  # type: ignore
print(var)
```
...
stg_q1 = ShortToGround(
    ...
    {  # type: ignore
        ...
        "pos_y": Tee.options.shift_y + Tee.options.tee_width / 2 + Tee.options.ext_len,  # type: ignore
        "orientation": "270",
    },
)
stg_r1 = ShortToGround(
    ...
    {  # type: ignore
        ...
        "pos_y": port_L.options.pos_y  # type: ignore
        - TL_gap
        - res_gap
...
q_loop = RectangleHollow(
    ...
    dict(  # type: ignore
        pos_x=Q1.options.pos_x  # type: ignore
        - (q_loop_trace + q_loop_width + Q1.options.arm_width) / 2,  # type: ignore
        pos_y=Q1.options.pos_y,  # type: ignore
...
port_fl = LaunchpadWirebondDriven(
    ...
    options=dict(  # type: ignore
        ...
        taper_height=0.5,
        pos_x=-x_TL,
        pos_y=fl_loop_stg_1.options.pos_y,  # type: ignore
        orientation="  0",
        lead_length=0.05,
    ),
)
...
result_path = (
    rf"C:\Users\SQC\Desktop\Axel\Qubit-measure\result\{project_name}\data\LjSweep.csv"
)
...
renderer.modeler.mesh_length("JJ", ["JJ_rect_Lj_Q1_rect_jj"], MaxLength="0.01mm")
renderer.modeler.mesh_length(
    "pad_and_lines",
    [
        "pad_bot_0_Q1",
...
renderer.start()
renderer.activate_ansys_design("4a_fl_mutual_dm", "drivenmodal")
...
# renderer.modeler.mesh_length('cpw_mesh', ['trace_R1', 'trace_TL'], MaxLength='0.007mm')
dm_fl.close()
```
