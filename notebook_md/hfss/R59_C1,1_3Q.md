...
stg_q1 = ShortToGround(
    ...
    "stg_q1",
    {
        ...
        "pos_y": Tee_1.options.shift_y
        + Tee_1.options.tee_width / 2
        + Tee_1.options.ext_len,
        "orientation": "270",
    },
)
...
stg_q2 = ShortToGround(
    ...
    "stg_q2",
    {
        "pos_x": Q2.options.pos_x,
        "pos_y": Tee_2.options.shift_y
        + Tee_2.options.tee_width / 2
        + Tee_2.options.ext_len,
        "orientation": "270",
    },
)
stg_r2 = ShortToGround(
    ...
    "stg_r2",
    {
        "pos_x": Q2.options.pos_x - (l_couple + fillet),
        "pos_y": port_L1.options.pos_y
        - TL_gap
        - res_gap
        - (TL_width + res_width) / 2
...
stg_q3 = ShortToGround(
    ...
    "stg_q3",
    {
        "pos_x": Q3.options.pos_x,
        "pos_y": Tee_3.options.shift_y
        + Tee_3.options.tee_width / 2
        + Tee_3.options.ext_len,
        "orientation": "270",
    },
)
stg_r3 = ShortToGround(
    ...
    "stg_r3",
    {
        "pos_x": Q3.options.pos_x - (l_couple + fillet),
        "pos_y": port_L1.options.pos_y
        - TL_gap
        - res_gap
        - (TL_width + res_width) / 2
...
fl_loop_stg_2A = ShortToGround(
    ...
    "fl_loop_stg_2A",
    dict(
        pos_x=Q2.options.pos_x - Q2.options.pocket_width / 2,
        pos_y=Q2.options.pos_y - loop_H / 2,
        orientation=180,
    ),
)
...
fl_loop_stg_3A = ShortToGround(
    ...
    "fl_loop_stg_3A",
    dict(
        pos_x=Q3.options.pos_x + Q3.options.pocket_width / 2,
        pos_y=Q3.options.pos_y - loop_H / 2,
        orientation=0,
    ),
)
...
cl_q1_gap_2 = Rectangle(
    ...
    dict(
        pos_x=Q2.options.pos_x,
        pos_y=Q2.options.pos_y - Q2.options.pocket_height / 2 - cl_grd - cl_ext / 2,
        width=cpw_gap * 2 + cpw_width,
        height=cl_ext,
        subtract=True,
    ),
...
cl_q_stg_2 = ShortToGround(
    ...
    dict(
        pos_x=Q2.options.pos_x,
        pos_y=Q2.options.pos_y
        - Q2.options.pocket_height / 2
        - cl_grd
        - cl_ext
        + cl_vac,
        orientation=90,
...
cl_q1_gap_3 = Rectangle(
    ...
    dict(
        pos_x=Q3.options.pos_x,
        pos_y=Q3.options.pos_y - Q3.options.pocket_height / 2 - cl_grd - cl_ext / 2,
        width=cpw_gap * 2 + cpw_width,
        height=cl_ext,
        subtract=True,
    ),
...
cl_q_stg_3 = ShortToGround(
    ...
    dict(
        pos_x=Q3.options.pos_x,
        pos_y=Q3.options.pos_y
        - Q3.options.pocket_height / 2
        - cl_grd
        - cl_ext
        + cl_vac,
        orientation=90,
...
```python
design.renderers.gds.export_to_gds(rf"../../result/{project_name}/data/{project_name}.gds")
```
