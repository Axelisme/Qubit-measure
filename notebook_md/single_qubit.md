...
```python
dump_device_info(os.path.join(em.flx_dir, "device_info.json"))
```
...
exp_cfg = {
    ...
    "sweep": make_sweep(4000, 6100, step=1.0),
    "relax_delay": 0.5,  # us
}
...
```python
%matplotlib inline
md.best_ro_length, fig = opt_ro_len_exp.analyze(t0=1.0)
md.best_ro_length
```
